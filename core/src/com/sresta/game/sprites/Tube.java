...
public class Tube {
    ...
    private static final int TUBE_GAP = 80; // difference between two tubes
    private static final int LOWEST_OPENING = 120;//lowest available opening for top of bottom tube
    ...
    public void reposition(float x){
        /*Method to reposition tubes to further X-axis*/
